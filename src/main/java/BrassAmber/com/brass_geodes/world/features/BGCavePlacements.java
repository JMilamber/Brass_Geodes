...
public class BGCavePlacements {
    ...
    public static final PlacedFeature BG_AMETHYST_GEODE = PlacementUtils.register("bg_amethyst_geode",
            BGConfiguredFeatures.BG_AMETHYST_GEODE.placed(RarityFilter.onAverageOnceEvery(BrassGeodesConfig.amethystGeodeChance.get() + baseChance),
