...
public class BGShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    private final BGRecipeCategory category;
    ...
    public BGShapedRecipeBuilder(BGRecipeCategory recipeCategory, ItemLike itemLike, int count) {
        this.category = recipeCategory;
        this.result = itemLike.asItem();
        this.count = count;
    }

    public static BGShapedRecipeBuilder shaped(BGRecipeCategory p_250853_, ItemLike p_249747_) {
        return shaped(p_250853_, p_249747_, 1);
    }

    public static BGShapedRecipeBuilder shaped(BGRecipeCategory p_251325_, ItemLike p_250636_, int p_249081_) {
        return new BGShapedRecipeBuilder(p_251325_, p_250636_, p_249081_);
    }

    public BGShapedRecipeBuilder define(Character p_206417_, TagKey<Item> p_206418_) {
        return this.define(p_206417_, Ingredient.of(p_206418_));
    }

    public BGShapedRecipeBuilder define(Character p_126128_, ItemLike p_126129_) {
        return this.define(p_126128_, Ingredient.of(p_126129_));
    }

    public BGShapedRecipeBuilder define(Character p_126125_, Ingredient p_126126_) {
    ...
    public BGShapedRecipeBuilder pattern(String p_126131_) {
    ...
    public BGShapedRecipeBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
        this.advancement.addCriterion(p_126133_, p_126134_);
        return this;
    }

    public BGShapedRecipeBuilder group(@Nullable String p_126146_) {
        this.group = p_126146_;
        return this;
    }

    public BGShapedRecipeBuilder showNotification(boolean p_273326_) {
    ...
    static CraftingBookCategory determineBookCategory(BGRecipeCategory pCategory) {
